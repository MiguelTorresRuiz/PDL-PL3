 ...
 * {@link SQLMINIParser}.
 */
public interface SQLMINIParserListener extends ParseTreeListener {
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SQLMINIParser#comentario}.
	 * @param ctx the parse tree
	 */
	void enterComentario(SQLMINIParser.ComentarioContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLMINIParser#comentario}.
	 * @param ctx the parse tree
	 */
	void exitComentario(SQLMINIParser.ComentarioContext ctx);
	/**
	 * Enter a parse tree produced by {@link SQLMINIParser#textos}.
	 * @param ctx the parse tree
	 */
	void enterTextos(SQLMINIParser.TextosContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLMINIParser#textos}.
	 * @param ctx the parse tree
	 */
	void exitTextos(SQLMINIParser.TextosContext ctx);
}